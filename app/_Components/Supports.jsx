...
const Supports = () => {
  return (
    <div className='relative grid grid-cols-4 gap-10 py-10'>
      <div className='flex flex-col items-center text-center border-2 border-gray-300/40 rounded-md p-12 space-y-4 hover:border-primary transition-all duration-300'>
      ...
      <div className='flex flex-col border-2 items-center text-center border-gray-300/40 rounded-md p-12 space-y-4 hover:border-primary transition-all duration-300'>
